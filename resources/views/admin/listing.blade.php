...
@endif
   ...
   <div class="form-group">
    ...
    <input type="checkbox" name="featured" id="featured" value="1"<?php if(isset($listing->sticky) && $listing->sticky == 1){ ?> CHECKED <?php } ?>>
  </div>
  <div class="form-group">
...
<div class="custom-control custom-radio">
  ...
  <label class="custom-control-label" for="customRadio2">I am looking for</label>
   ...
   <label for="type">Categories:</label>
    <select class="form-control" id="listingtype" name="listingtype"><option value="0">All</option>
  	@foreach($listingtypes as $type)
      
      <option value="{{$type->id}}"<?php if(isset($listing->listingtype) && $listing->listingtype == $type->id){ ?> SELECTED <?php } ?>>{{$type->name}}</option>
    @endforeach
    </select> 
  <div class="form-group">
    <label for="title">Title</label>
    <input type="text" name="title" class="form-control" id="title" placeholder="Title of my Ad!" value="{{isset($listing->name) ? $listing->name : ''}}">
  </div>
  <div>
  <div class="form-group">
    <label for="description">Description</label>
    <textarea class="form-control" id="description" name="description" rows="6" cols="40">{{isset($listing->description) ? $listing->description : ''}}</textarea>
...
<div class="custom-control custom-radio">
  ...
  <label for="photo1">Choose a picture</label>
  </div>
  <div id="photo2_group">
